...
const Header = () => {
  ...
  return (
    <>
      <div className="flex justify-between items-center w-full py-4 px-8 bg-[#FFFFFF] shadow-[0_4px_4px_-1px_rgba(0,0,0,0.1)] 
      fixed top-0 z-90   
      sm:px-24
      lg:px-40
      dark:bg-[#000F14]">
        <div className="w-full">
          ...
          <div className="hidden gap-8 font-bold text-[16px] text-[#262626]   sm:flex   dark:text-[#F5F5F5]">
        ...
        <div className="flex items-center gap-4">
          <button onClick={toggleLanguage} className="font-medium text-[#262626] cursor-pointer   
          hover:text-[#0096C7]   
          dark:text-[#F5F5F5]">
